...
VALUES ('2023-01-10 09:30:00+05:30', (SELECT id FROM department WHERE name = 'Medical'), 'Amit', 'Sharma',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6', '2023-09-20 10:15:00+05:30'),
       ('2023-02-15 11:00:00+05:30', (SELECT id FROM department WHERE name = 'Security'), 'Rajesh', 'Singh',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6', '2023-09-21 12:45:00+05:30'),
       ('2023-03-20 14:25:00+05:30', (SELECT id FROM department WHERE name = 'Security'), 'Suman', 'Verma',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6', '2023-09-19 08:30:00+05:30'),
       ('2023-04-10 17:40:00+05:30', (SELECT id FROM department WHERE name = 'Electrical'), 'Kavita', 'Patel',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6', '2023-09-22 09:20:00+05:30'),
       ('2023-05-05 08:15:00+05:30', (SELECT id FROM department WHERE name = 'Sanitation'), 'Pooja', 'Naik',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6', '2023-09-18 11:35:00+05:30'),
       ('2023-06-12 10:00:00+05:30', (SELECT id FROM department WHERE name = 'Sanitation'), 'Vijay', 'Bansal',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6', '2023-09-17 16:45:00+05:30'),
       ('2023-07-18 13:35:00+05:30', (SELECT id FROM department WHERE name = 'Operations'), 'Rakesh', 'Gupta',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6', '2023-09-16 14:50:00+05:30'),
       ('2023-08-25 07:50:00+05:30', (SELECT id FROM department WHERE name = 'Maintenance'), 'Sunita', 'Mehta',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6', '2023-09-15 08:10:00+05:30'),
       ('2023-09-01 16:45:00+05:30', (SELECT id FROM department WHERE name = 'Catering'), 'Manoj', 'Mishra',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6', '2023-09-14 17:25:00+05:30'),
       ('2023-09-10 12:25:00+05:30', (SELECT id FROM department WHERE name = 'Human Resources'), 'Neha', 'Kapoor',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6', '2023-09-13 11:00:00+05:30'),
       ('2023-09-15 15:10:00+05:30', (SELECT id FROM department WHERE name = 'Human Resources'), 'Arjun', 'Iyer',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6', '2023-09-12 12:30:00+05:30'),
       ('2023-09-20 11:20:00+05:30', (SELECT id FROM department WHERE name = 'Human Resources'), 'Priya', 'Jain',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6', '2023-09-11 16:45:00+05:30'),
       ('2023-09-25 14:05:00+05:30', (SELECT id FROM department WHERE name = 'General'), 'Rahul', 'Saxena',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6', '2023-09-10 14:35:00+05:30'),
       ('2023-09-27 18:30:00+05:30', (SELECT id FROM department WHERE name = 'General'), 'Anita', 'Rao',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6', '2023-09-09 09:45:00+05:30'),
       ('2023-09-28 10:50:00+05:30', (SELECT id FROM department WHERE name = 'General'), 'Ashok', 'Menon',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6', '2023-09-08 10:20:00+05:30');
...
VALUES ('2023-01-15 09:10:00+05:30', '2023-09-20 12:30:00+05:30', 9876543210, 'Rohit', 'Kumar',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6',
        gen_random_uuid()),
       ('2023-02-20 14:25:00+05:30', '2023-09-21 10:15:00+05:30', 9876543211, 'Sneha', 'Reddy',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6',
        gen_random_uuid()),
       ('2023-03-10 17:35:00+05:30', '2023-09-19 08:50:00+05:30', 9876543212, 'Vikram', 'Patil',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6',
        gen_random_uuid()),
       ('2023-04-18 08:45:00+05:30', '2023-09-22 09:00:00+05:30', 9876543213, 'Anjali', 'Desai',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6',
        gen_random_uuid()),
       ('2023-05-25 11:00:00+05:30', '2023-09-18 16:35:00+05:30', 9876543214, 'Pankaj', 'Singh',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6',
        gen_random_uuid()),
       ('2023-06-05 10:05:00+05:30', '2023-09-17 18:20:00+05:30', 9876543215, 'Meera', 'Chauhan',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6',
        gen_random_uuid()),
       ('2023-07-15 12:10:00+05:30', '2023-09-16 14:40:00+05:30', 9876543216, 'Rahul', 'Joshi',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6',
        gen_random_uuid()),
       ('2023-08-10 09:20:00+05:30', '2023-09-15 11:10:00+05:30', 9876543217, 'Sonal', 'Shah',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6',
        gen_random_uuid()),
       ('2023-09-01 15:40:00+05:30', '2023-09-14 17:50:00+05:30', 9876543218, 'Arvind', 'Nair',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6',
        gen_random_uuid()),
       ('2023-09-05 07:50:00+05:30', '2023-09-13 09:30:00+05:30', 9876543219, 'Ishita', 'Roy',
        '$2a$10$b30zJT8zARA6.Ne.8cPjMOvy/i03jxkUr9A3zBvWT9UiN2U.1R0q6',
        gen_random_uuid());
